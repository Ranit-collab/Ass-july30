...
<body>
    <div class="game-container">
        ...
        if (isset($_SESSION['playerAScore'])) {
            if($diceMatrix[$_SESSION['playerAScore']] == $safePosition || ($_SESSION['playerAScore'] == 0 && $_SESSION['playerBScore'] == 0)){
        ...
        if (isset($_SESSION['playerBScore'])) {
            if($diceMatrix[$_SESSION['playerBScore']] == $safePosition || ($_SESSION['playerAScore'] == 0 && $_SESSION['playerBScore'] == 0)){
